...
public class BottomRightSwitch implements PathContainer {
    ...
    public Path buildPath() {
        ...
        sWaypoints.add(new Waypoint(80,110,10,60));
	...
	// WAYPOINT_DATA: [{"position":{"x":0,"y":70},"speed":60,"radius":0,"comment":""},{"position":{"x":40,"y":70},"speed":60,"radius":20,"comment":""},{"position":{"x":80,"y":110},"speed":60,"radius":10,"comment":""},{"position":{"x":140,"y":110},"speed":60,"radius":0,"comment":""}]
	// IS_REVERSED: false
